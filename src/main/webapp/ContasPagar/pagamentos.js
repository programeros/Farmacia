...
function incluir(){
    window.location.assign("novosPagamentos.jsp");
}
...
function alterar(){
    ...
    document.location.href = "/Farmacia/AlterarPagamento?id="+celula;
}
//ARRUMAR!!!
function visualizar(){
    linha = document.getElementsByTagName('tr')[selected];
    ...
    celula = coluna[0].innerText;
     ...
     document.location.href = "/Farmacia/VisualizarPagamento?id="+celula;
}
...
function excluir(){  
    ...
    coluna = linha.getElementsByTagName("td");
    celula = coluna[0].innerText;
    document.location.href = "/Farmacia/ExcluirPagamento?id="+celula;
}
