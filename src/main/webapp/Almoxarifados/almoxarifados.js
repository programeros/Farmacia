...
function incluir(){
    window.location.assign("cadastroAlmoxarifado.jsp");
}
...
function alterar(){
    ...
    document.location.href = "/Farmacia/AlterarAlmoxarifado?id="+celula;
}
//ARRUMAR!!!
function visualizar(){
    linha = document.getElementsByTagName('tr')[selected];
    ...
    celula = coluna[0].innerText;
     ...
     document.location.href = "/Farmacia/VisualizarAlmoxarifado?id="+celula;
}
...
function excluir(){  
    ...
    coluna = linha.getElementsByTagName("td");
    celula = coluna[0].innerText;
    document.location.href = "/Farmacia/ExcluirAlmoxarifado?id="+celula;
}
