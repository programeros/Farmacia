...
function incluir(){
    window.location.assign("cadastroVendedor.jsp");
}
...
function alterar(){
    ...
    document.location.href = "/Farmacia/AlterarVendedor?id="+celula;
}
//ARRUMAR!!!
function visualizar(){
    linha = document.getElementsByTagName('tr')[selected];
...
function excluir(){  
    ...
    coluna = linha.getElementsByTagName("td");
    celula = coluna[0].innerText;
    document.location.href = "/Farmacia/ExcluirVendedor?id="+celula;
}
