...
function incluir(){
    window.location.assign("produtosTransferencia.jsp");
}
...
function alterar(){
    ...
    document.location.href = "/Farmacia/AlterarTransferencia?id="+celula;
}
//ARRUMAR!!!
function visualizar(){
    linha = document.getElementsByTagName('tr')[selected];
    ...
    celula = coluna[0].innerText;
     ...
     document.location.href = "/Farmacia/VisualizarTransferencia?id="+celula;
}
...
function excluir(){  
    ...
    coluna = linha.getElementsByTagName("td");
    celula = coluna[0].innerText;
    document.location.href = "/Farmacia/ExcluirTransferencia?id="+celula;
}
