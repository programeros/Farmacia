...
function incluir(){
    window.location.assign("novosRecebimentos.jsp");
}
...
function alterar(){
    ...
    document.location.href = "/Farmacia/AlterarRecebimento?id="+celula;
}
//ARRUMAR!!!
function visualizar(){
    linha = document.getElementsByTagName('tr')[selected];
    ...
    celula = coluna[0].innerText;
     ...
     document.location.href = "/Farmacia/VisualizarRecebimento?id="+celula;
}
...
function excluir(){  
    ...
    coluna = linha.getElementsByTagName("td");
    celula = coluna[0].innerText;
    document.location.href = "/Farmacia/ExcluirRecebimento?id="+celula;
}
